...
BEGIN
    UPDATE CLIENTE
    -- TABELA CLIENTE
    WHERE ID_CLIENTE = CLIENTE_NOVO;
    INSERT INTO CLIENTE (ID_CLIENTE, NOME_CLIENTE)
    VALUES (CLIENTE_NOVO, NOME_CLIENTE);

    UPDATE EXTRATO
    INSERT INTO EXTRATO(ID_EXTRATO, SALDO, DATA_EXTRATO, LIMITE, CLIENTE)
    VALUES (0, 0, NOW(), LIMITE_CLIENTE, CLIENTE_NOVO); 
END;
$$ LANGUAGE plpgsql;


NOVO_CLIENTE(1, 'ZE NGM', 100000);
NOVO_CLIENTE(2, 'MARIA NGM', 80000);
